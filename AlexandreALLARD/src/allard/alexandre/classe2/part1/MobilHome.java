...
public class MobilHome {
        public int id;
        public int taille; // 0 = petit 1 = grand;
        public int prix;
        public int jour_debut_location;
        public int jour_fin_location;

        public MobilHome(int id, int taille, int prix, int jour_debut_location, int jour_fin_location) {
        ...
        public void display(){
            String tailleString = "";
            if (taille == 0) {
                 tailleString = "taille : petit";
                 prix = 30;
            } else {
                 tailleString = "taille : grand";
                 prix = 50;
            }
            if (jour_fin_location == 0 && jour_debut_location == 0) { //Emplacement libre car jour début et fin sont à zéro
                System.out.println("Emplacement " + id + " : " + tailleString + "m2 = libre");
            } else { //Emplacement loué
                System.out.println("Emplacement " + id + " : " + tailleString + "m2 = actuellement loué du jour " + jour_debut_location + " au jour " + jour_fin_location);
